...
public class TGC_GLWebCanvas {
    ...
    public TGC_GLWeb gl;
    public TGS_Func_In2<Integer, Boolean> onFocused;

    public TGC_GLWebCanvas(int id, TGC_GLWeb gl, int xOffSet, int yOffSet, int width, int height, Integer qualityPercent_default100, TGC_GLWebRender render, TGS_Func_In2<Integer, Boolean> onFocused) {

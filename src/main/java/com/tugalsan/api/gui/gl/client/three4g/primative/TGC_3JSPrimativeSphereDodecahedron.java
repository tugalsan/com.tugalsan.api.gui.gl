...
public class TGC_3JSPrimativeSphereDodecahedron extends TGC_3JSPrimativeAbstract {

    public static int MIN_DETAIL() {
        return 0;
    }

    public TGC_3JSPrimativeSphereDodecahedron(TGC_GLProgramAbstract program, CharSequence name, float radius) {
        this(program, name, radius, null, null);
    }

    public TGC_3JSPrimativeSphereDodecahedron(TGC_GLProgramAbstract program, CharSequence name, float radius, TGC_GLTexture2DAbstract texture, TGC_GLTextureCube environment) {
        this(program, name, radius, MIN_DETAIL(), texture, environment);
    }

    public TGC_3JSPrimativeSphereDodecahedron(TGC_GLProgramAbstract program, CharSequence name, float radius, int detail) {
        this(program, name, radius, detail, null, null);
    }

    public TGC_3JSPrimativeSphereDodecahedron(TGC_GLProgramAbstract program, CharSequence name, float radius, int detail, TGC_GLTexture2DAbstract texture, TGC_GLTextureCube environment) {
